...
![Language: Go](https://img.shields.io/badge/Language-Go-facc15?style=flat-square&labelColor=0d1117)
...
`go-dns-recon` is a focused, lightweight, and deterministic tool designed for developers and power users. Engineered from first principles with zero bloat, high responsiveness, and clean modular code.

```
┌────────────────────────────────────────────────────────────────────────┐
│  SYSTEM ARCHITECTURE: GO-DNS-RECON                                     │
